...
public class TC01_Add_Cart2 {
  ...
  public void CartTest() throws Exception 
  {
		...
		WebElement A54=findElement(By.xpath("//a[@aria-label='Phantomx']"));
		...
		System.out.println("Price of PhantomX : "+Price);
		...
		String CartAmount=findElement(By.xpath("//span[@id='sc-subtotal-label-buybox']//following-sibling::span")).getText();
		String CartAmount1=findElement(By.xpath("//span[@id='sc-subtotal-label-activecart']//following-sibling::span")).getText();
		
		Float Total_Cart_Amount1=getFloat_From_String(CartAmount);
		Float Total_Cart_Amount2=getFloat_From_String(CartAmount1);
		
		if(Total_Cart_Amount==Total_Cart_Amount1  &&  Total_Cart_Amount==Total_Cart_Amount2 )
		{
			
			Reporter.log("Passed Validation - Cart amount cross check  and passed");
			Assert.assertTrue(true);
			
		}
		else
		{
			Reporter.log("Failed Validation - Cart amount cross check  and Failed");

...
public class TC01_Add_Skills_Static2 {
  ...
  public void SkillsTest() throws Exception {
	 ...
	 // TC01_Add_Skills_Static2.OpenChromeBrowser();
	  
	  driver=TestBrowser.OpenChromeBrowser();
	  TC01_Add_Skills_Static2.OpenOrangeHRm(TestURL);  //Step3
	  TC01_Add_Skills_Static2.Login(userName,Password); //Step3
	  TC01_Add_Skills_Static2.AddSkills(SkillName,SkillDescr);//Step3
	  TC01_Add_Skills_Static2.closeBrowser();

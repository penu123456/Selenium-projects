...
public class TC01_Add_Jobs_Static2 {
	...
	String JobTitle="Sales16",JobDescr="Sales16 descr",JobNote="Sales16 Note";//step2
	
	
  @Test
  public void JobsTest() throws Exception {
	  
	 // TC01_Add_Jobs_Static2.OpenChromeBrowser();
	  
	  driver=TestBrowser.OpenChromeBrowser();
	  
	  TC01_Add_Jobs_Static2.OpenOrangeHRM(TestURL);
	  TC01_Add_Jobs_Static2.Login(userName, Password);
	  TC01_Add_Jobs_Static2.AddJobs(JobTitle, JobDescr, JobNote);

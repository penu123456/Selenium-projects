...
public class TC01_Add_Locations2 {
	...
	//Step1 - copy and paste dataprovider synatx - Test Data modification
	 ...
	 @DataProvider(name = "TC01_Add_Locations")
		public static Object[][] Authentication1() throws Exception {
			...
			Object[][] data = eat.getTableArray("C://HTML Report//OrangeHRM6//Test2_Location.xlsx", "Sheet1");
  ...
  public void LocationsTest(String TestURL,String USerName,String Password,String City,String Country)throws Exception {
	  
	  TC01_Add_Locations2 T1=new TC01_Add_Locations2();

...
public class TC01_Add_Skills_NonStatic_Parametrs {
  ...
  @Test
  @Parameters({"Url","Username","Password","SkillName","SkillDesc"})
  public void SkilsTest(String TestURL,String UserName,String PassWord,String SkillName,String SkillDescr ) throws Exception {

								    		...
								    		//*[@id="resultTable"]/tbody/tr[1]/td[2]
								      		...
								      		//*[@id="resultTable"]/tbody/tr[1]/td[2] 
								    	       ...
								    	       //System.out.println("Get Text Value is from the WebElement: " + valueIneed1);
								    	        ...
								    	        if (WebElementText.trim().length() != 0)
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC01_EMPExport.xls","Sheet5",i,k,WebElementText);
								    	        else
								    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC01_EMPExport.xls","Sheet5",i,k,"No Data");

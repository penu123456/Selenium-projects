...
public class TC01_FindElementsStaticMethods {
  ...
  public void CartTest() throws Exception 
  {
	  ...
	  TC01_FindElementsStaticMethods.OpenChrome();
	  TC01_FindElementsStaticMethods.GetMobileNames();
  ...
  public static void GetMobileNames()throws Exception
  {

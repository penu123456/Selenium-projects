...
public class TC01_Nationality2 {
	...
	String NationalityText="Indian157";
  ...
  public void MainTest1() throws Exception {
	  ...
	  TC01_Nationality2 T2=new TC01_Nationality2();
	  
	  T2.OpenChromeBrowser();
	  T2.OpenOrangeHRM(TestURL); //Step2
	  T2.Login(UserName,Password);//Step2
	  T2.AddNationalities(NationalityText);//Step2
  ...
  public void AddNationalities(String NationalityText1) throws Exception {

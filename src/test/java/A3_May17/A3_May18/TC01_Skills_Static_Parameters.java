...
public class TC01_Skills_Static_Parameters {
	...
	String SkillName="Java21",SkillDescr="Java21 descr";
  ...
  public void MainTest1() throws Exception {
	  ...
	  TC01_Skills_Static_Parameters.OpenChromeBrowser();
	  TC01_Skills_Static_Parameters.OpenOrangeHRM(TestURl);//Step2 - Passing Global variables to methods
	  TC01_Skills_Static_Parameters.Login(UserName,Password);//Step2 - Passing Global variables to methods
	  TC01_Skills_Static_Parameters.AddSkills(SkillName,SkillDescr);//Step2 - Passing Global variables to methods

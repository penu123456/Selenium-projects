...
public class TC01_Add_Jobs_Non_Static_Parameter {
  ...
  public void JobsTest() throws Exception {
	  ...
	  TC01_Add_Jobs_Non_Static_Parameter T2=new TC01_Add_Jobs_Non_Static_Parameter();
	  
		T2.OpenChromeBrowser();
		T2.OpenOrangeHRM(TestURL);//Step2  - Passing Global variables to Main Methods
